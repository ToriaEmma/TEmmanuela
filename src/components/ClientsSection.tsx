...
const ClientsSection = () => (
  ...
  <section className="clients-section relative z-[60] -mt-[400px] w-screen overflow-hidden bg-black px-5 pb-16 pt-0 text-white md:z-auto md:mt-0 md:px-8 md:pb-24">
